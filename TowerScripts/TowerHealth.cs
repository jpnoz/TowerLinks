...
{
    public int startingHealth = 200; // Starting health of the tower
    ...
    public void Heal(float amount)
    {
        ...
        currentHealth = Mathf.Min(currentHealth, startingHealth); // Clamp current health to starting health
